...
- **NEP**: Loads a WASM module based on the [PyNEP] {ttps://github.com/bigd4/PyNEP} which allows loading neuroevolution potentials (NEPs). Using WASM this means that the calculation runs on YOUR device. No data is sent to a backend for this calculation. It allows currently the calculation of energy, forces and stress. A relaxed and MD enginge will be added in the future. 
