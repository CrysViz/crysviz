...
export function setupSecondStructureInput({ onLoadStructure, setStatus }) {
  const fileInput = document.getElementById('secondFileInput');
  const fileLabel = document.getElementById('secondFileLabel');
  const inputModeButtons = Array.from(document.querySelectorAll('.second-input-mode-btn'));
  const fileInputContainer = document.getElementById('secondFileInputContainer');
  const textInputContainer = document.getElementById('secondTextInputContainer');
  const structureText = document.getElementById('secondStructureText');
  const loadTextButton = document.getElementById('secondLoadTextButton');
