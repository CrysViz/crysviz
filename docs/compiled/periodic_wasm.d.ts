...
export interface InitOutput {
    ...
    readonly polyhedraresult_band_kcore_ms: (a: number) => number;
    ...
    readonly polyhedraresult_centered_voronoi_ms: (a: number) => number;
