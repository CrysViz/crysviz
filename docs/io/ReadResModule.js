/**
 * Parser for Res (SHELX-style) files (supports multiple structures per file)
 ...
 * Parses the file content and returns a StructureContainer; row creation and
 * insertion into the structureShip are handled by the caller (the loader).
 * @param {string} content - File content
 * @param {string} fileName - File name
 * @returns {Promise<StructureContainer>} Promise resolving to a StructureContainer
 */
