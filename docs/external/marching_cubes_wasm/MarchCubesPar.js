...
async function MarchCubes(moduleArg = {}) {
  var moduleRtn;
...
function writeStackCookie() {
  ...
  // ever overwritten.
  (growMemViews(), HEAPU32)[_asan_js_check_index((growMemViews(), HEAPU32), ((max) >>> 2) >>> 0, ___asan_storeN)] = 34821223;
  (growMemViews(), HEAPU32)[_asan_js_check_index((growMemViews(), HEAPU32), (((max) + (4)) >>> 2) >>> 0, ___asan_storeN)] = 2310721022;
}
...
function checkStackCookie() {
  ...
  var cookie1 = (growMemViews(), HEAPU32)[_asan_js_check_index((growMemViews(), HEAPU32), ((max) >>> 2) >>> 0, ___asan_loadN)];
  var cookie2 = (growMemViews(), HEAPU32)[_asan_js_check_index((growMemViews(), HEAPU32), (((max) + (4)) >>> 2) >>> 0, ___asan_loadN)];
...
function initMemory() {
  ...
  if (Module["wasmMemory"]) {
    ...
    var INITIAL_MEMORY = Module["INITIAL_MEMORY"] || 630390784;
...
function findWasmBinary() {
  if (Module["locateFile"]) {
    return locateFile("MarchCubesPar.wasm");
  }
  // Use bundler-friendly `new URL(..., import.meta.url)` pattern; works in browsers too.
  return new URL("MarchCubesPar.wasm", import.meta.url).href;
}
...
/** @type{function(number, (number|boolean), ...number)} */ var proxyToMainThread = (funcIndex, emAsmAddr, proxyMode, ...callArgs) => {
  ...
  for (var arg of callArgs) {
    if (typeof arg == "bigint") {
      ...
      (growMemViews(), HEAP64)[_asan_js_check_index((growMemViews(), HEAP64), b++ >>> 0, ___asan_storeN)] = 1n;
      (growMemViews(), HEAP64)[_asan_js_check_index((growMemViews(), HEAP64), b++ >>> 0, ___asan_storeN)] = arg;
    } else {
      // The prefix is zero to indicate a JS Number.
      (growMemViews(), HEAP64)[_asan_js_check_index((growMemViews(), HEAP64), b++ >>> 0, ___asan_storeN)] = 0n;
      (growMemViews(), HEAPF64)[_asan_js_check_index((growMemViews(), HEAPF64), b++ >>> 0, ___asan_storeN)] = arg;
    }
  }
...
var PThread = {
  ...
  allocateUnusedWorker() {
    ...
    worker = new Worker(new URL("MarchCubesPar.js", import.meta.url), {
      "type": "module",
      // This is the way that we signal to the node worker that it is hosting
      // a pthread.
      "workerData": "em-pthread",
...
/**
  ...
  switch (type) {
   case "i1":
    return (growMemViews(), HEAP8)[_asan_js_check_index((growMemViews(), HEAP8), ptr >>> 0, ___asan_loadN)];

   case "i8":
    return (growMemViews(), HEAP8)[_asan_js_check_index((growMemViews(), HEAP8), ptr >>> 0, ___asan_loadN)];

   case "i16":
    return (growMemViews(), HEAP16)[_asan_js_check_index((growMemViews(), HEAP16), ((ptr) >>> 1) >>> 0, ___asan_loadN)];

   case "i32":
    return (growMemViews(), HEAP32)[_asan_js_check_index((growMemViews(), HEAP32), ((ptr) >>> 2) >>> 0, ___asan_loadN)];

   case "i64":
    return (growMemViews(), HEAP64)[_asan_js_check_index((growMemViews(), HEAP64), ((ptr) >>> 3) >>> 0, ___asan_loadN)];

   case "float":
    return (growMemViews(), HEAPF32)[_asan_js_check_index((growMemViews(), HEAPF32), ((ptr) >>> 2) >>> 0, ___asan_loadN)];

   case "double":
    return (growMemViews(), HEAPF64)[_asan_js_check_index((growMemViews(), HEAPF64), ((ptr) >>> 3) >>> 0, ___asan_loadN)];

   case "*":
    return (growMemViews(), HEAPU32)[_asan_js_check_index((growMemViews(), HEAPU32), ((ptr) >>> 2) >>> 0, ___asan_loadN)];
...
/**
  ...
  switch (type) {
   case "i1":
    (growMemViews(), HEAP8)[_asan_js_check_index((growMemViews(), HEAP8), ptr >>> 0, ___asan_storeN)] = value;
    break;
   ...
   case "i16":
    (growMemViews(), HEAP16)[_asan_js_check_index((growMemViews(), HEAP16), ((ptr) >>> 1) >>> 0, ___asan_storeN)] = value;
    break;

   case "i32":
    (growMemViews(), HEAP32)[_asan_js_check_index((growMemViews(), HEAP32), ((ptr) >>> 2) >>> 0, ___asan_storeN)] = value;
    break;

   case "i64":
    (growMemViews(), HEAP64)[_asan_js_check_index((growMemViews(), HEAP64), ((ptr) >>> 3) >>> 0, ___asan_storeN)] = BigInt(value);
    break;

   case "float":
    (growMemViews(), HEAPF32)[_asan_js_check_index((growMemViews(), HEAPF32), ((ptr) >>> 2) >>> 0, ___asan_storeN)] = value;
    break;

   case "double":
    (growMemViews(), HEAPF64)[_asan_js_check_index((growMemViews(), HEAPF64), ((ptr) >>> 3) >>> 0, ___asan_storeN)] = value;
    break;

   case "*":
    (growMemViews(), HEAPU32)[_asan_js_check_index((growMemViews(), HEAPU32), ((ptr) >>> 2) >>> 0, ___asan_storeN)] = value;
    break;
...
class ExceptionInfo {
  ...
  set_type(type) {
    (growMemViews(), HEAPU32)[_asan_js_check_index((growMemViews(), HEAPU32), (((this.ptr) + (4)) >>> 2) >>> 0, ___asan_storeN)] = type;
  }
  get_type() {
    return (growMemViews(), HEAPU32)[_asan_js_check_index((growMemViews(), HEAPU32), (((this.ptr) + (4)) >>> 2) >>> 0, ___asan_loadN)];
  }
  set_destructor(destructor) {
    (growMemViews(), HEAPU32)[_asan_js_check_index((growMemViews(), HEAPU32), (((this.ptr) + (8)) >>> 2) >>> 0, ___asan_storeN)] = destructor;
  }
  get_destructor() {
    return (growMemViews(), HEAPU32)[_asan_js_check_index((growMemViews(), HEAPU32), (((this.ptr) + (8)) >>> 2) >>> 0, ___asan_loadN)];
  }
  set_caught(caught) {
    caught = caught ? 1 : 0;
    (growMemViews(), HEAP8)[_asan_js_check_index((growMemViews(), HEAP8), (this.ptr) + (12) >>> 0, ___asan_storeN)] = caught;
  }
  get_caught() {
    return (growMemViews(), HEAP8)[_asan_js_check_index((growMemViews(), HEAP8), (this.ptr) + (12) >>> 0, ___asan_loadN)] != 0;
  }
  set_rethrown(rethrown) {
    rethrown = rethrown ? 1 : 0;
    (growMemViews(), HEAP8)[_asan_js_check_index((growMemViews(), HEAP8), (this.ptr) + (13) >>> 0, ___asan_storeN)] = rethrown;
  }
  get_rethrown() {
    return (growMemViews(), HEAP8)[_asan_js_check_index((growMemViews(), HEAP8), (this.ptr) + (13) >>> 0, ___asan_loadN)] != 0;
  }
  ...
  set_adjusted_ptr(adjustedPtr) {
    (growMemViews(), HEAPU32)[_asan_js_check_index((growMemViews(), HEAPU32), (((this.ptr) + (16)) >>> 2) >>> 0, ___asan_storeN)] = adjustedPtr;
  }
  get_adjusted_ptr() {
    return (growMemViews(), HEAPU32)[_asan_js_check_index((growMemViews(), HEAPU32), (((this.ptr) + (16)) >>> 2) >>> 0, ___asan_loadN)];
  }
}
...
var SYSCALLS = {
  ...
  writeStat(buf, stat) {
    (growMemViews(), HEAPU32)[_asan_js_check_index((growMemViews(), HEAPU32), ((buf) >>> 2) >>> 0, ___asan_storeN)] = stat.dev;
    (growMemViews(), HEAPU32)[_asan_js_check_index((growMemViews(), HEAPU32), (((buf) + (4)) >>> 2) >>> 0, ___asan_storeN)] = stat.mode;
    (growMemViews(), HEAPU32)[_asan_js_check_index((growMemViews(), HEAPU32), (((buf) + (8)) >>> 2) >>> 0, ___asan_storeN)] = stat.nlink;
    (growMemViews(), HEAPU32)[_asan_js_check_index((growMemViews(), HEAPU32), (((buf) + (12)) >>> 2) >>> 0, ___asan_storeN)] = stat.uid;
    (growMemViews(), HEAPU32)[_asan_js_check_index((growMemViews(), HEAPU32), (((buf) + (16)) >>> 2) >>> 0, ___asan_storeN)] = stat.gid;
    (growMemViews(), HEAPU32)[_asan_js_check_index((growMemViews(), HEAPU32), (((buf) + (20)) >>> 2) >>> 0, ___asan_storeN)] = stat.rdev;
    (growMemViews(), HEAP64)[_asan_js_check_index((growMemViews(), HEAP64), (((buf) + (24)) >>> 3) >>> 0, ___asan_storeN)] = BigInt(stat.size);
    (growMemViews(), HEAP32)[_asan_js_check_index((growMemViews(), HEAP32), (((buf) + (32)) >>> 2) >>> 0, ___asan_storeN)] = 4096;
    (growMemViews(), HEAP32)[_asan_js_check_index((growMemViews(), HEAP32), (((buf) + (36)) >>> 2) >>> 0, ___asan_storeN)] = stat.blocks;
    var atime = stat.atime.getTime();
    var mtime = stat.mtime.getTime();
    var ctime = stat.ctime.getTime();
    (growMemViews(), HEAP64)[_asan_js_check_index((growMemViews(), HEAP64), (((buf) + (40)) >>> 3) >>> 0, ___asan_storeN)] = BigInt(Math.floor(atime / 1e3));
    (growMemViews(), HEAPU32)[_asan_js_check_index((growMemViews(), HEAPU32), (((buf) + (48)) >>> 2) >>> 0, ___asan_storeN)] = (atime % 1e3) * 1e3 * 1e3;
    (growMemViews(), HEAP64)[_asan_js_check_index((growMemViews(), HEAP64), (((buf) + (56)) >>> 3) >>> 0, ___asan_storeN)] = BigInt(Math.floor(mtime / 1e3));
    (growMemViews(), HEAPU32)[_asan_js_check_index((growMemViews(), HEAPU32), (((buf) + (64)) >>> 2) >>> 0, ___asan_storeN)] = (mtime % 1e3) * 1e3 * 1e3;
    (growMemViews(), HEAP64)[_asan_js_check_index((growMemViews(), HEAP64), (((buf) + (72)) >>> 3) >>> 0, ___asan_storeN)] = BigInt(Math.floor(ctime / 1e3));
    (growMemViews(), HEAPU32)[_asan_js_check_index((growMemViews(), HEAPU32), (((buf) + (80)) >>> 2) >>> 0, ___asan_storeN)] = (ctime % 1e3) * 1e3 * 1e3;
    (growMemViews(), HEAP64)[_asan_js_check_index((growMemViews(), HEAP64), (((buf) + (88)) >>> 3) >>> 0, ___asan_storeN)] = BigInt(stat.ino);
    return 0;
  },
  writeStatFs(buf, stats) {
    (growMemViews(), HEAPU32)[_asan_js_check_index((growMemViews(), HEAPU32), (((buf) + (4)) >>> 2) >>> 0, ___asan_storeN)] = stats.bsize;
    (growMemViews(), HEAPU32)[_asan_js_check_index((growMemViews(), HEAPU32), (((buf) + (60)) >>> 2) >>> 0, ___asan_storeN)] = stats.bsize;
    (growMemViews(), HEAP64)[_asan_js_check_index((growMemViews(), HEAP64), (((buf) + (8)) >>> 3) >>> 0, ___asan_storeN)] = BigInt(stats.blocks);
    (growMemViews(), HEAP64)[_asan_js_check_index((growMemViews(), HEAP64), (((buf) + (16)) >>> 3) >>> 0, ___asan_storeN)] = BigInt(stats.bfree);
    (growMemViews(), HEAP64)[_asan_js_check_index((growMemViews(), HEAP64), (((buf) + (24)) >>> 3) >>> 0, ___asan_storeN)] = BigInt(stats.bavail);
    (growMemViews(), HEAP64)[_asan_js_check_index((growMemViews(), HEAP64), (((buf) + (32)) >>> 3) >>> 0, ___asan_storeN)] = BigInt(stats.files);
    (growMemViews(), HEAP64)[_asan_js_check_index((growMemViews(), HEAP64), (((buf) + (40)) >>> 3) >>> 0, ___asan_storeN)] = BigInt(stats.ffree);
    (growMemViews(), HEAPU32)[_asan_js_check_index((growMemViews(), HEAPU32), (((buf) + (48)) >>> 2) >>> 0, ___asan_storeN)] = stats.fsid;
    (growMemViews(), HEAPU32)[_asan_js_check_index((growMemViews(), HEAPU32), (((buf) + (64)) >>> 2) >>> 0, ___asan_storeN)] = stats.flags;
    // ST_NOSUID
    (growMemViews(), HEAPU32)[_asan_js_check_index((growMemViews(), HEAPU32), (((buf) + (56)) >>> 2) >>> 0, ___asan_storeN)] = stats.namelen;
  },
...
function ___syscall_mkdirat(dirfd, path, mode) {
  if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(6, 0, 1, dirfd, path, mode);
  path >>>= 0;
  try {
    path = SYSCALLS.getStr(path);
...
var syscallGetVarargI = () => {
  ...
  var ret = (growMemViews(), HEAP32)[_asan_js_check_index((growMemViews(), HEAP32), ((+SYSCALLS.varargs) >>> 2) >>> 0, ___asan_loadN)];
  SYSCALLS.varargs += 4;
  return ret;
};
...
var AsciiToString = ptr => {
  ...
  var str = "";
  while (1) {
    var ch = (growMemViews(), HEAPU8)[_asan_js_check_index((growMemViews(), HEAPU8), ptr++ >>> 0, ___asan_loadN)];
    if (!ch) return str;
...
var integerReadValueFromPointer = (name, width, signed) => {
  ...
  switch (width) {
   case 1:
    return signed ? pointer => (growMemViews(), HEAP8)[_asan_js_check_index((growMemViews(), 
    HEAP8), pointer >>> 0, ___asan_loadN)] : pointer => (growMemViews(), HEAPU8)[_asan_js_check_index((growMemViews(), 
    HEAPU8), pointer >>> 0, ___asan_loadN)];

   case 2:
    return signed ? pointer => (growMemViews(), HEAP16)[_asan_js_check_index((growMemViews(), 
    HEAP16), ((pointer) >>> 1) >>> 0, ___asan_loadN)] : pointer => (growMemViews(), 
    HEAPU16)[_asan_js_check_index((growMemViews(), HEAPU16), ((pointer) >>> 1) >>> 0, ___asan_loadN)];

   case 4:
    return signed ? pointer => (growMemViews(), HEAP32)[_asan_js_check_index((growMemViews(), 
    HEAP32), ((pointer) >>> 2) >>> 0, ___asan_loadN)] : pointer => (growMemViews(), 
    HEAPU32)[_asan_js_check_index((growMemViews(), HEAPU32), ((pointer) >>> 2) >>> 0, ___asan_loadN)];

   case 8:
    return signed ? pointer => (growMemViews(), HEAP64)[_asan_js_check_index((growMemViews(), 
    HEAP64), ((pointer) >>> 3) >>> 0, ___asan_loadN)] : pointer => (growMemViews(), 
    HEAPU64)[_asan_js_check_index((growMemViews(), HEAPU64), ((pointer) >>> 3) >>> 0, ___asan_loadN)];
...
/** @suppress {globalThis} */ function __embind_register_bool(rawType, name, trueValue, falseValue) {
  ...
  registerType(rawType, {
    ...
    readValueFromPointer: function(pointer) {
      return this.fromWireType((growMemViews(), HEAPU8)[_asan_js_check_index((growMemViews(), 
      HEAPU8), pointer >>> 0, ___asan_loadN)]);
    },
    destructorFunction: null
  });
...
/** @suppress {globalThis} */ function readPointer(pointer) {
  return this.fromWireType((growMemViews(), HEAPU32)[_asan_js_check_index((growMemViews(), 
  HEAPU32), ((pointer) >>> 2) >>> 0, ___asan_loadN)]);
}
...
var heap32VectorToArray = (count, firstElement) => {
  ...
  for (var i = 0; i < count; i++) {
    ...
    array.push((growMemViews(), HEAPU32)[_asan_js_check_index((growMemViews(), HEAPU32), (((firstElement) + (i * 4)) >>> 2) >>> 0, ___asan_loadN)]);
  }
  return array;
};
  ...
  switch (width) {
   case 4:
    return function(pointer) {
      return this.fromWireType((growMemViews(), HEAPF32)[_asan_js_check_index((growMemViews(), 
      HEAPF32), ((pointer) >>> 2) >>> 0, ___asan_loadN)]);
    };

   case 8:
    return function(pointer) {
      return this.fromWireType((growMemViews(), HEAPF64)[_asan_js_check_index((growMemViews(), 
      HEAPF64), ((pointer) >>> 3) >>> 0, ___asan_loadN)]);
    };
...
function __embind_register_memory_view(rawType, dataTypeIndex, name) {
  ...
  function decodeMemoryView(handle) {
    var size = (growMemViews(), HEAPU32)[_asan_js_check_index((growMemViews(), HEAPU32), ((handle) >>> 2) >>> 0, ___asan_loadN)];
    var data = (growMemViews(), HEAPU32)[_asan_js_check_index((growMemViews(), HEAPU32), (((handle) + (4)) >>> 2) >>> 0, ___asan_loadN)];
...
function __embind_register_std_string(rawType, name) {
  ...
  registerType(rawType, {
    ...
    fromWireType(value) {
      var length = (growMemViews(), HEAPU32)[_asan_js_check_index((growMemViews(), HEAPU32), ((value) >>> 2) >>> 0, ___asan_loadN)];
      var payload = value + 4;
      var str;
      if (stdStringIsUTF8) {
        ...
        str = "";
        for (var i = 0; i < length; ++i) {
          str += String.fromCharCode((growMemViews(), HEAPU8)[_asan_js_check_index((growMemViews(), 
          HEAPU8), payload + i >>> 0, ___asan_loadN)]);
        }
      }
      _free(value);
      return str;
    ...
    toWireType(destructors, value) {
      ...
      var ptr = base + 4;
      (growMemViews(), HEAPU32)[_asan_js_check_index((growMemViews(), HEAPU32), ((base) >>> 2) >>> 0, ___asan_storeN)] = length;
      if (valueIsOfTypeString) {
        if (stdStringIsUTF8) {
          ...
          for (var i = 0; i < length; ++i) {
            ...
            (growMemViews(), HEAPU8)[_asan_js_check_index((growMemViews(), HEAPU8), ptr + i >>> 0, ___asan_storeN)] = charCode;
          }
        }
      } else {
...
var UTF16ToString = (ptr, maxBytesToRead, ignoreNul) => {
  ...
  for (var i = idx; i < endIdx; ++i) {
    var codeUnit = (growMemViews(), HEAPU16)[_asan_js_check_index((growMemViews(), HEAPU16), i >>> 0, ___asan_loadN)];
...
var stringToUTF16 = (str, outPtr, maxBytesToWrite) => {
  ...
  for (var i = 0; i < numCharsToWrite; ++i) {
    ...
    // possibly a lead surrogate
    (growMemViews(), HEAP16)[_asan_js_check_index((growMemViews(), HEAP16), ((outPtr) >>> 1) >>> 0, ___asan_storeN)] = codeUnit;
    outPtr += 2;
  }
  // Null-terminate the pointer to the HEAP.
  (growMemViews(), HEAP16)[_asan_js_check_index((growMemViews(), HEAP16), ((outPtr) >>> 1) >>> 0, ___asan_storeN)] = 0;
...
var UTF32ToString = (ptr, maxBytesToRead, ignoreNul) => {
  ...
  for (var i = 0; !(i >= maxBytesToRead / 4); i++) {
    var utf32 = (growMemViews(), HEAPU32)[_asan_js_check_index((growMemViews(), HEAPU32), startIdx + i >>> 0, ___asan_loadN)];
...
var stringToUTF32 = (str, outPtr, maxBytesToWrite) => {
  ...
  for (var i = 0; i < str.length; ++i) {
    ...
    (growMemViews(), HEAP32)[_asan_js_check_index((growMemViews(), HEAP32), ((outPtr) >>> 2) >>> 0, ___asan_storeN)] = codePoint;
    outPtr += 4;
    if (outPtr + 4 > endPtr) break;
  }
  // Null-terminate the pointer to the HEAP.
  (growMemViews(), HEAP32)[_asan_js_check_index((growMemViews(), HEAP32), ((outPtr) >>> 2) >>> 0, ___asan_storeN)] = 0;
  return outPtr - startPtr;
};
...
function __embind_register_std_wstring(rawType, charSize, name) {
  ...
  registerType(rawType, {
    ...
    toWireType: (destructors, value) => {
      ...
      (growMemViews(), HEAPU32)[_asan_js_check_index((growMemViews(), HEAPU32), ((ptr) >>> 2) >>> 0, ___asan_storeN)] = length / charSize;
...
function __emscripten_receive_on_main_thread_js(funcIndex, emAsmAddr, callingThread, bufSize, args, ctx, ctxArgs) {
  ...
  while (b < end) {
    var arg;
    if ((growMemViews(), HEAP64)[_asan_js_check_index((growMemViews(), HEAP64), b++ >>> 0, ___asan_loadN)]) {
      // It's a BigInt.
      arg = (growMemViews(), HEAP64)[_asan_js_check_index((growMemViews(), HEAP64), b++ >>> 0, ___asan_loadN)];
    } else {
      // It's a Number.
      arg = (growMemViews(), HEAPF64)[_asan_js_check_index((growMemViews(), HEAPF64), b++ >>> 0, ___asan_loadN)];
    }
...
function __emscripten_sanitizer_get_option(name) {
  name >>>= 0;
  return stringToNewUTF8(Module[UTF8ToString(name)] || "");
}
...
function __mmap_js(len, prot, flags, fd, offset, allocated, addr) {
  if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(10, 0, 1, len, prot, flags, fd, offset, allocated, addr);
  len >>>= 0;
  ...
  try {
    ...
    var ptr = res.ptr;
    (growMemViews(), HEAP32)[_asan_js_check_index((growMemViews(), HEAP32), ((allocated) >>> 2) >>> 0, ___asan_storeN)] = res.allocated;
    (growMemViews(), HEAPU32)[_asan_js_check_index((growMemViews(), HEAPU32), ((addr) >>> 2) >>> 0, ___asan_storeN)] = ptr;
    return 0;
  } catch (e) {
    if (typeof FS == "undefined" || !(e.name === "ErrnoError")) throw e;
    return -e.errno;
...
function __munmap_js(addr, len, prot, flags, fd, offset) {
  if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(11, 0, 1, addr, len, prot, flags, fd, offset);
  addr >>>= 0;
  len >>>= 0;
  offset = bigintToI53Checked(offset);
  try {
...
function _clock_time_get(clk_id, ignored_precision, ptime) {
  ...
  (growMemViews(), HEAP64)[_asan_js_check_index((growMemViews(), HEAP64), ((ptime) >>> 3) >>> 0, ___asan_storeN)] = BigInt(nsec);
  return 0;
}
...
function _emscripten_stack_unwind_buffer(addr, buffer, count) {
  ...
  for (var i = 0; i < count && stack[i + offset]; ++i) {
    (growMemViews(), HEAP32)[_asan_js_check_index((growMemViews(), HEAP32), (((buffer) + (i * 4)) >>> 2) >>> 0, ___asan_storeN)] = convertFrameToPC(stack[i + offset]);
  }
  return i;
}
...
function _environ_get(__environ, environ_buf) {
  ...
  for (var string of getEnvStrings()) {
    ...
    (growMemViews(), HEAPU32)[_asan_js_check_index((growMemViews(), HEAPU32), (((__environ) + (envp)) >>> 2) >>> 0, ___asan_storeN)] = ptr;
...
function _environ_sizes_get(penviron_count, penviron_buf_size) {
  ...
  (growMemViews(), HEAPU32)[_asan_js_check_index((growMemViews(), HEAPU32), ((penviron_count) >>> 2) >>> 0, ___asan_storeN)] = strings.length;
  var bufSize = 0;
  for (var string of strings) {
    bufSize += lengthBytesUTF8(string) + 1;
  }
  (growMemViews(), HEAPU32)[_asan_js_check_index((growMemViews(), HEAPU32), ((penviron_buf_size) >>> 2) >>> 0, ___asan_storeN)] = bufSize;
  return 0;
}
...
/** @param {number=} offset */ var doReadv = (stream, iov, iovcnt, offset) => {
  ...
  for (var i = 0; i < iovcnt; i++) {
    var ptr = (growMemViews(), HEAPU32)[_asan_js_check_index((growMemViews(), HEAPU32), ((iov) >>> 2) >>> 0, ___asan_loadN)];
    var len = (growMemViews(), HEAPU32)[_asan_js_check_index((growMemViews(), HEAPU32), (((iov) + (4)) >>> 2) >>> 0, ___asan_loadN)];
    iov += 8;
...
function _fd_read(fd, iov, iovcnt, pnum) {
  ...
  try {
    ...
    (growMemViews(), HEAPU32)[_asan_js_check_index((growMemViews(), HEAPU32), ((pnum) >>> 2) >>> 0, ___asan_storeN)] = num;
    return 0;
  } catch (e) {
    if (typeof FS == "undefined" || !(e.name === "ErrnoError")) throw e;
    return e.errno;
...
function _fd_seek(fd, offset, whence, newOffset) {
  ...
  try {
    ...
    (growMemViews(), HEAP64)[_asan_js_check_index((growMemViews(), HEAP64), ((newOffset) >>> 3) >>> 0, ___asan_storeN)] = BigInt(stream.position);
...
var proxiedFunctionTable = [ _proc_exit, exitOnMainThread, pthreadCreateProxied, ___syscall_dup, ___syscall_fstat64, ___syscall_lstat64, ___syscall_mkdirat, ___syscall_newfstatat, ___syscall_openat, ___syscall_stat64, __mmap_js, __munmap_js, _environ_get, _environ_sizes_get, _fd_close, _fd_read, _fd_seek, _fd_write ];
...
var wasmSourceMapFile = locateFile("MarchCubesPar.wasm.map");
