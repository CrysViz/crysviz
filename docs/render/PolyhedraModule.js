...
function NewupdatePolyhedra() {
  ...
  if (!general.showPolyhedra) { app.scene.add(groups.polyhedraGroup); return; }
 ...
 // --- Sorting candidates: larger N first, centered over cages ---
  ...
  if(DEBUG) console.info('[poly DEBUG] total candidates rendered:',groups.polyhedraGroup.children.length);
}
