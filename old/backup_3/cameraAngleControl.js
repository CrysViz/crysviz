...
export function updateAngleDisplays(controls) {
...
export function applyRotationFromUI(directionDeg, axis, controls) {
  ...
  const v = camera.position.clone().sub(center); // do NOT mutate center
  v.applyQuaternion(q);
