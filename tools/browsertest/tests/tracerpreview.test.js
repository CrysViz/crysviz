...
(async () => {
  ...
  // --- (2) Persistence round trip (only rtRasterPreview, v2.12; delay ignored) ------
  ...
  H.check('captureState persists rtRasterPreview at v2.12 but NOT the hidden rest delay',
    persist.version === '2.12' && persist.savedPreviewKey && persist.restDelayAbsent, JSON.stringify(persist));
