...
//   (5) the material persists through captureState/applySharedState at v2.14;
...
(async () => {
  ...
  // --- (5) Persistence: fieldMaterial round-trips through capture/apply at 2.14 -----
  ...
  H.check('captureState/applySharedState round-trips fieldMaterial at v2.14',
    persist.version === '2.14'
